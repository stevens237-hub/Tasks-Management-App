...
import { Button, Tabs, TaskColor } from "../components";
import {
...
const SubTaskList = ({ subTasks, taskId }) => {
  const [changeStatus] = useChangeSubTaskStatusMutation();
  ...
  return (
    <div className="space-y-3">
      <h4 className="text-lg font-semibold">Sub-Tasks</h4>
          ...
          {subTasks.map((subTask) => (
            ...
            >
              ...
              <span className="text-sm text-gray-500">
                {moment(subTask.date).format('MMM DD, YYYY')}
              </span>
            </div>
          ))}
        </div>
